...
$('.hovr').mouseover(function() {
    $(this).siblings('p').addClass('hvrst');
});

$('.hovr').mouseleave(function() {
    $(this).siblings('p').removeClass('hvrst');
});
...
var hamburgers = document.querySelectorAll(".reshamb");
