...
(function() {
    ...
    function FileSelectHandler(e) {
        ...
        if (this.value != "") {
            document.getElementById('upldimg_1').style.display = 'none';
            document.getElementById('pro_bx_1').style.display = 'block';
        }
        setTimeout(function() {
            document.getElementById('pro_bx_1').style.display = 'none';
            document.getElementById('main_drag2_1').style.display = 'none';
            document.getElementById('mainDrag3_1').style.display = 'block';
        }, 2500);
    ...
    function ParseFile(file) {
        Output(
            ...
            document.getElementById('textfile_1').innerHTML = file.name
        );
    }
